 ...
 */
public class Main {                                             //This is a Example of JProcessing GUI Implementation
    public static void main(String[] args){                     //    by Creating a Subclass of <JProcessing.Processing>
        GUIWindow GUI=new GUIWindow();
    }
}
//================================================================================================================================
// Global Variables can be Declared and Initialized Here.

class GUIWindow extends JProcessing.Processing {

    // Processing Variables can also be Declared and Initialized Here.
    //     However, they only have up to 100ms to Initialize before <setup()> is Invoked
